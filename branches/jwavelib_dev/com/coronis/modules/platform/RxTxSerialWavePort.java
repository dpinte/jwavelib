 ...
 * $Revision: 123 $
 * $Author: abertrand $
 * $HeadURL: https://secure2.svnrepository.com/s_dpinte/jwavelib/branches/jwavelib_dev/com/coronis/modules/platform/RxTxSerialWavePort.java $
 */
...
public class RxTxSerialWavePort extends WavePort {
    ...
    public RxTxSerialWavePort(String name, String sport, int retries) {
...
//		}
	...
	public boolean disconnect() {
        ...
        isConnected = false;
        Logger.debug("Waveport disconnected");
