...
public class SnifferResSendFrame	extends ResSendFrame
	...
	public SnifferResSendFrame(final int cmd, final int[] msg, final int[]ts,
								final int[] head, final int[] foot, final int dir) {
		super(cmd, msg);
