 ...
 *
 * $Date: 2009-07-24 09:46:51 +0200 (Fri, 24 Jul 2009) $
 * $Revision: 121 $
 * $Author: abertrand $
 * $HeadURL: https://secure2.svnrepository.com/s_dpinte/jwavelib/branches/jwavelib_dev/com/coronis/modules/platform/Win32SerialWavePort.java $
 */
...
public class Win32SerialWavePort extends WavePort {
    ...
    public Win32SerialWavePort(String name, String sport, int retries) {
    	super(name, sport, retries);
    }
